...
namespace Game.Factory
{
    internal class WorldFactory
    {
        internal World CreateWorld()
        {
            ...
            newWorld.AddSpecialAttack("Fireball", World.MagicIDFireball, "Throw a fireball to enemy. Base Damage: 3 + 0.8 for each Intelligence point. Mana cost: 5", 3f, 5, 0.8f, null, Skills.Target.Enemy, Skills.Attribute.Intelligence, Skills.SpecialAttackType.FireMagic, GameItems.WeaponType.None);
            newWorld.AddSpecialAttack("Fireball II", World.MagicIDFireball2, "Throw an even bigger fireball to enemy. Base Damage: 5 + 1.5 for each Intelligence point. May apply burn to tager. Mana cost: 15", 5f, 15, 1.5f, World.StatusEffectByID(World.StatusEffectIDBurn), Skills.Target.Enemy, Skills.Attribute.Intelligence, Skills.SpecialAttackType.FireMagic, GameItems.WeaponType.None);
            newWorld.AddSpecialAttack("Ice Arrow", World.MagicIDIceArrow, "Create an arrow of ice and shoot it to the enemy. Base Damage: 2 + 1.2 for each Intelligence point. Mana cost: 7", 1f, 7, 1.2f, null, Skills.Target.Enemy, Skills.Attribute.Intelligence, Skills.SpecialAttackType.IceMagic, GameItems.WeaponType.None);
            newWorld.AddSpecialAttack("Thunder Bolt", World.MagicIDThunderBolt, "Summon a lightning bolt than strike the enemy. Base Damage: 5 + 1 for each Intelligence point. Mana cost: 10", 5f, 10, 1f, null, Skills.Target.Enemy, Skills.Attribute.Intelligence, Skills.SpecialAttackType.LightningMagic, GameItems.WeaponType.None);
            newWorld.AddSpecialAttack("Small Heal", World.MagicIDSmallHeal, "Cure yourself with magic. Base healing: 5 + 1.5 for Mind point. Mana cost: 10", 5, 10, 1.5f, null, Skills.Target.Self, Skills.Attribute.Mind, Skills.SpecialAttackType.HealingMagic, GameItems.WeaponType.None);
            newWorld.AddSpecialAttack("Regeneration", World.MagicIDRegeneration, "Casting regeneration, that heal your wounds over time. Base healing: 5 + 1.5 for Mind point. Mana cost: 10", 5, 10, 1.5f, World.StatusEffectByID(World.StatusEffectIDRegeneration), Skills.Target.Self, Skills.Attribute.Mind, Skills.SpecialAttackType.HealingMagic, GameItems.WeaponType.None);


            newWorld.AddSpecialAttack("Sword: Fast Strike", World.SwordSKillIDFastStrike, "Deal fast strike with sword. Base Damage: 3 + 0.8 for each Agility point. Mana Cost: 5", 3, 5, 0.8f, null, Skills.Target.Enemy, Skills.Attribute.Agility, Skills.SpecialAttackType.PhysicalSkill, GameItems.WeaponType.Sword);
            newWorld.AddSpecialAttack("Sword: Heavy Strike", World.SwordSKillIDHeavyStrike, "Deal heavy strike with sword. Base Damage: 5 + 1.5 for each Strength point. Mana Cost 15", 5, 15, 1.5f, World.StatusEffectByID(World.StatusEffectIDBleed), Skills.Target.Enemy, Skills.Attribute.Strength, Skills.SpecialAttackType.PhysicalSkill, GameItems.WeaponType.Sword);
            newWorld.AddSpecialAttack("Sword: MultiHit", World.SwordSKillIDMultiHit, "Deals multiple hits (from 2 to 5). Base Damage from 1 hit: 2 + 0.5 for each Agility point. Mana Cost 10", 2, 10, 0.5f, null, Skills.Target.Enemy, Skills.Attribute.Agility, Skills.SpecialAttackType.PhysicalSkill, GameItems.WeaponType.Sword);

            newWorld.AddSpecialAttack("Staff: Headbash", World.StaffSkillIDHeadBash, "Strike enemie's head with your staff. Base Damage: 5 + 1 for each point of strength. Mana Cost 10", 5, 10, 1f, null, Skills.Target.Enemy, Skills.Attribute.Agility, Skills.SpecialAttackType.PhysicalSkill, GameItems.WeaponType.Staff);
