...
namespace Game.GameLocations
{
    internal class WorldFactory
    {
        internal World CreateWorld()
        {
            ...
            newWorld.AddMagic("ThunderStrike", World.MagicIDThunderStrike, "Summon a thunder than strike the enemy. Base Damage: 5 + 1 for each Intelligence point. Mana cost: 10", 5f, 10, 1f, SkillsAndMagic.Target.Enemy, SkillsAndMagic.Attribute.Intelligence, null);
            newWorld.AddMagic("Small Heal", World.MagicIDSmallHeal, "Cure yourself with magic. Base healing: 5 + 1.5 for Mind point. Mana cost: 10", 5, 10, 1.5f, SkillsAndMagic.Target.Self, SkillsAndMagic.Attribute.Mind, null);
            newWorld.AddMagic("Regeneration", World.MagicIDSmallHeal, "Casting regeneration, that heal your wounds over time. Base healing: 5 + 1.5 for Mind point. Mana cost: 10", 5, 10, 1.5f, SkillsAndMagic.Target.Self, SkillsAndMagic.Attribute.Mind, World.StatusEffectByID(World.StatusEffectIDRegeneration));
